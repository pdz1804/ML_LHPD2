...
\begin{center}
    ...
    \hline
    1 & Nguyen Quang Phu & 2252621 & Team leader; Manage repository and schedule; Stacking \& Voting with Logistic Regressions; Final integration \& verification. \\
    \hline
    2 & Pham Huynh Bao Dai & 2252139 & Implement PCA, SVM; Visualizations; Document his models' workflow. \\
    \hline
    3 & Nguyen Thanh Dat & 2252145 & Implement LDA, Random Forest, XGBoost; Document ensemble methods and classifiers. \\
    \hline
    4 & Nguyen Tien Hung & 2252280 & Build Bayesian Networks, HMMs, Logistic Regression; Stacking with good models from Assignment 1; Document graphical models. \\
    \hline
    5 & Nguyen Thien Loc & 2252460 & Implement BiLSTM-CRF; Evaluate models; Voting with good models; Performance analysis and comparison. \\
    \hline
    \end{tabularx}
\end{center}
...
\begin{itemize}
    ...
    \item The submitted README file is stored in the repository at: \url{https://github.com/pdz1804/ML_LHPD2/blob/main/notebooks/assignment2/ML_LHPD2_Ass2_README.md}
    \item The team's report for Assignment 2 is located in: \url{https://github.com/pdz1804/ML_LHPD2/tree/main/reports/final_project/}
