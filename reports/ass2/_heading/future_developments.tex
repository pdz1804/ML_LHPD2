...
\begin{itemize}
    \item \textbf{Model Deployment:} We would love in the future to deploy these models to some cloud databases (such as Oracle Cloud database) that support us to host our models and we do not need to store them locally anymore.
