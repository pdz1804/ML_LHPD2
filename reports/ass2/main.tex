...
%\include{_heading/01_list_and_workload}
\include{_heading/02_abstract_description}

% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\chapter{Project Organization and Repository Structure}
    \input{_heading/03_progress}

\chapter{Code Engineering}
    \input{_heading/04_dataset}
    \input{_heading/05_preprocessing}
    \input{_heading/06_visualize}

% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\input{_heading/07_analyze_result}
\input{_heading/07_discussion_and_analysis}
    
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\chapter{Self-Reflection}
    \input{_heading/future_developments}
    \input{_heading/07_lesson_learned}
    \input{_heading/special_thanks}

% \include{_heading/09_ref.tex}
